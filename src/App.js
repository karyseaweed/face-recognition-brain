...
class App extends Component {
  ...
  // componentDidMount() {
  //   fetch('https://arcane-fjord-50002.herokuapp.com/users')
  ...
  onDetectSubmit = () => {
    ...
    fetch('https://arcane-fjord-50002.herokuapp.com/imageurl', {
      method: 'post',
      ...
      .then((response) => {
        if (response) {
          fetch('https://arcane-fjord-50002.herokuapp.com/image', {
            method: 'put',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
